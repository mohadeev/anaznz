...
const Seo = ({ SeoTile, DescMeta, ImageSeo }) => {
  const [HostName, setHostName] = useState("dfdfdf");
  useEffect(() => {
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="twitter:site" content={`@${SeoTile}`} />
        <meta name="twitter:creator" content={`@${SeoTile}`} />
