...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = "3 Days Tour from Fes via Merzouga to Marrakech";
  const ProgramName = "3 Days Tour from Fes via Merzouga to Marrakech";
  ...
  const FocuseKeyFour = " 3 Days Fes Via Merzouga Desert ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou8.jpg",
      image1postion: "center",

      // A FOOD IMAGES /

      image2: "/../../../images/merzouga-images/camp-mages/camp-images-11.jpg",
      image2postion: "center",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-11.jpg",

      image3postion: "",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-15.jpg",
      image4postion: "",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-12.jpg",
      image5postion: "",

      // ACTIVTIES 4 QUAD BIKE OR Sky
      image6: "/../../../images/natural/natural1.jpg",
  ...
  const [SeoArray, setSeoArray] = useState([
    {
      descmeta: `  private & shared 3 Day Fes to Marrakech Desert tour it's an occasion to be amused by Erg Chebbi, Old villages, Oasis. Camel trek tour and night at Desert camp. Free Booking! ${
