...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = " 4 Days Tour from Fes to Marrakech via Merzouga Desert ";
  const ProgramName = " 4 Days Tour from Fes to Marrakech via Merzouga Desert ";

  const FocuseKeyOne = " 4 Days Trip Morocco Itinerary From Fes";
  const FocuseKeyTwo = " 4 Day Sahara Desert Tour Morocco staring Fes ";
  const FocuseKeyTree = " 4 Days Tour Package from Fes ";
  const FocuseKeyFour = " 4 Days Fes to Merzouga Desert ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou10.jpg",
      image1postion: "center",

      // A FOOD IMAGES /

      image2: "/../../../images/food-images/morocco-food15.jpg",
      image2postion: "center",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-12.jpg",

      image3postion: "",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-20.jpg",
      image4postion: "center",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-16.jpg",
      image5postion: "",

      // ACTIVTIES 4 QUAD BIKE OR Sky
      image6: "/../../../images/merzouga-images/quad-images/quad-images-12.jpg",
      image6postion: "left",
  ...
  const [SeoArray, setSeoArray] = useState([
    {
      descmeta:
        `${FocuseKeyOne}` +
        ` private & shared via ante Atlas Ifran, Desert Oasis, Erg Chebbi dunes, Camel Trek, Night at Camp under stars. Free Booking! ${
          FocuseKeyTwo + FocuseKeyTree + FocuseKeyFour
        }`,
      seotitle: SeoTitle,
      imageseo:
