...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = " 3 Days Tour from Fes to Merzouga Desert ";
  const ProgramName = " 3 Days Tour from Fes to Merzouga Desert ";

  const FocuseKeyOne = " 3 Days Trip Morocco Itinerary From Fes";
  const FocuseKeyTwo = " 3 Day Sahara Desert Tour Morocco staring Fes ";
  const FocuseKeyTree = " 3 Days Tour Package from Fes ";
  const FocuseKeyFour = " 3 Days Fes to Merzouga Desert ";

  //INFO ABOUT FIRST PART OF THE TOUR GO HERE
  const [TourArray, setTourArray] = useState([
    {
      // FIRST IMAGES HERE / Fes - OR DESERT /
      image:
        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-11.jpg",

      //THIS IMAGES SECOND IMAGES / FAMOUSE PLACE //
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou7.jpg",
      image1postion: "center",

      // A FOOD IMAGES /

      image2: "/../../../images/food-images/morocco-food13.jpg",
      image2postion: "center",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-9.jpg",

      image3postion: "",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-13.jpg",
      image4postion: "",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-10.jpg",
      image5postion: "",

      // ACTIVTIES 4 QUAD BIKE OR Sky
      image6: "/../../../images/merzouga-images/quad-images/quad-images-8.jpg",
      image6postion: "center",
  ...
  const [SeoArray, setSeoArray] = useState([
    {
      descmeta: ` 3 Day Tour Fes to Merzouga Desert via Atlas mountains, desert Oasis, Erg Chebbi dunes, Merzouga Camel Trek, and night at desert Camp under stars. Free Booking! ${SeoTitle + FocuseKeyOne + FocuseKeyTwo + FocuseKeyTree + FocuseKeyFour}`,
      seotitle: SeoTitle,
      imageseo:
