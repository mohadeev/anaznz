...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = " 5 Day Merzouga Desert Trip Marrakech to Fes. ";
  const ProgramName = " 5 Day Merzouga Desert Trip Fes to Marrakech.  ";

  const FocuseKeyOne = " 5 Days Trip Morocco Itinerary From Fes";
  const FocuseKeyTwo = " 5 Day Sahara Desert Tour Morocco starting Fes ";
  const FocuseKeyTree = " 5 Days Tour Package from Fes ";
  const FocuseKeyFour = " 5 Days Fes to Merzouga Desert ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou9.jpg",
      image1postion: "center",

      // A FOOD IMAGES /

      image2: "/../../../images/food-images/morocco-food16.jpg",
      image2postion: "bottom",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-13.jpg",

      image3postion: "",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-24.jpg",
      image4postion: "center",

      // CITY
      image5:
        "/../../../images/merzouga-images/desert-images/desert-images15.jpg",
      image5postion: "",

      // ACTIVTIES 4 QUAD BIKE OR Sky
      image6: "/../../../images/merzouga-images/quad-images/quad-images-14.jpg",
      image6postion: "left",
