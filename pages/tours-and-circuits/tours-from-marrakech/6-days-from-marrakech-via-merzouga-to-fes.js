...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = " 6 Days Tour from Marrakech Via Merzouga Desert to Fes ";
  const ProgramName = " 6 Days Tour from Marrakech Via Merzouga Desert to Fes";

  const FocuseKeyOne = " 6 Days Trip Morocco Itinerary ";
  const FocuseKeyTwo = " 6 Day Sahara Desert Tour Morocco staring Marrakech ";
  const FocuseKeyTree = " 6 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 6 Days Marrakech Via Merzouga Desert to Fes";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou6.jpg",
      image1postion: "center",

      // A FOOD IMAGES /

      image2: "/../../../images/food-images/morocco-food11.jpg",
      image2postion: "bottom",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-8.jpg",

      image3postion: "",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-12.jpg",
      image4postion: "",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-9.jpg",
      image5postion: "",

      // ACTIVTIES 4 QUAD BIKE OR Sky
      image6: "/../../../images/merzouga-images/quad-images/quad-images-10.jpg",
