...
const Index = () => {
  const id = "5MMF";
  const SeoTitle =
    "18 Days Grand Tour from Marrakech South East Merzouga and impirail Cities.";
  const ProgramName =
    "18 Days Grand Tour from Marrakech South East Merzouga & impirail Cities.";
  ...
  const [AllDays, setAllDays] = useState([
    ...
    {
      dayNumer: "3",
      tourId: "CSB-RBT-ASILA",
      blockstyle: "block",
    },
    {
      dayNumer: "4",
      tourId: "ASILAH-VIT-DAY",
      blockstyle: "block",
    },
    {
      dayNumer: "5",
      tourId: "ASILA-RIF-DIRCT-CHF",
      blockstyle: "block",
    },
    {
      dayNumer: "6",
