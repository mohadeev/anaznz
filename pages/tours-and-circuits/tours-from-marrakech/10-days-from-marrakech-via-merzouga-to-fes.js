...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = "10 Days Trip from Marrakech to Fes Via Merzouga Desert.";
  const ProgramName = "10 Days Trip from Marrakech to Fes Via Merzouga Desert.";

  const FocuseKeyOne = " 10 Day Dorocco Itinerary ";
  const FocuseKeyTwo = " 10 Day to Merzouga Desert Tour Morocco ";
  const FocuseKeyTree = " 10 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 10 Days Marrakech to Fes Via Merzouga Desert ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image:
        "/../../../images/merzouga-images/desert-images/desert-images22.jpg",
      imagepostion: "center",
      //THIS IMAGES SECOND IMAGES / FAMOUSE PLACE //
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou22.jpg",
      image1postion: "bottom",

      // A FOOD IMAGES /

      image2: "/../../../images/marrakech-images/marrakech-images-13.jpg",
      image2postion: "top-center",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-22.jpg",
