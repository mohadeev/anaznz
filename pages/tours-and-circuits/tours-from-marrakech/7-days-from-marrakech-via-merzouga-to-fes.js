...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = " 7 Days Trip from Marrakech Via Sahara Desert to Fes  ";
  const ProgramName = " 7 Days Trip from Marrakech Via Sahara Desert to Fes ";

  const FocuseKeyOne = " 7 Day Dorocco Itinerary ";
  const FocuseKeyTwo = " 7 Day to Merzouga Desert Tour Morocco ";
  const FocuseKeyTree = " 7 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 7 Days Marrakech to Fes Via Merzouga Desert ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou14.jpg",
      image1postion: "center",

      // A FOOD IMAGES /

      image2: "/../../../images/food-images/morocco-food17.jpg",
      image2postion: "top-center",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/fes-images/fes-images9.jpg",

      image3postion: "",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/altas-images/altas-images-16.jpg",
      image4postion: "",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-18.jpg",
      image5postion: "",
