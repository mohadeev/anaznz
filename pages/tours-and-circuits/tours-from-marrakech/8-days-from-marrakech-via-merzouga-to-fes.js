...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = "8 Days Tour from Marrakech to Fes Via Merzouga";
  const ProgramName = "8 Days Tour from Marrakech to Fes Via Merzouga";

  const FocuseKeyOne = " 8 Day Dorocco Itinerary ";
  const FocuseKeyTwo = " 8 Day to Merzouga Desert Tour Morocco ";
  const FocuseKeyTree = " 8 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 8 Days Marrakech to Fes Via Merzouga Desert ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou17.jpg",
      image1postion: "bottom",

      // A FOOD IMAGES /

      image2: "/../../../images/marrakech-images/marrakech-images-9.jpg",
      image2postion: "top-center",
        // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-18.jpg",

      image3postion: "bottom",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-29.jpg",
      image4postion: "",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-20.jpg",
      image5postion: "",

      // ACTIVTIES 4 QUAD BIKE OR Sky
      image6: "/../../../images/merzouga-images/quad-images/quad-images-7.jpg",
