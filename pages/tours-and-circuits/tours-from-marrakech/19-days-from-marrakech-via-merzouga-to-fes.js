...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = "19 Days Trip from Marrakech to Fes Via Merzouga Desert.";
  const ProgramName = "19 Days Trip from Marrakech to Fes Via Merzouga Desert.";

  const FocuseKeyOne = " 19 Day Dorocco Itinerary ";
  const FocuseKeyTwo = " 19 Day to Merzouga Desert Tour Morocco ";
  const FocuseKeyTree = " 19 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 19 Days Marrakech to Fes Via Merzouga Desert ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou24.jpg",
      image1postion: "bottom",

      // A FOOD IMAGES /

      image2: "/../../../images/fes-images/fes-images13.jpg",
      image2postion: "",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-23.jpg",

      image3postion: "bottom",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-34.jpg",
      image4postion: "",

      // CITY
      image5: "/../../../images/fes-images/fes-images12.jpg",
      image5postion: "",

      // ACTIVTIES 4 QUAD BIKE OR Sky
      image6: "/../../../images/merzouga-images/quad-images/quad-images-16.jpg",
      image6postion: "top",
