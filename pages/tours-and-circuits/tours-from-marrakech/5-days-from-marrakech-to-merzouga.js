...
const Index = () => {
  const id = "5MMF";
  const SeoTitle =
    "  5 Days Round Tour from Marrakech Via Merzouga Sahara Desert ";
  const ProgramName =
    " 5 Days Round Tour from Marrakech Via Merzouga Sahara Desert ";

  const FocuseKeyOne = " 5 Day Dorocco Itinerary ";
  const FocuseKeyTwo = " 5 Day Sahara Desert Tour Morocco ";
  const FocuseKeyTree = " 5 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 5 Days Marrakech Via Merzouga Desert ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou5.webp",
      // A FOOD IMAGES /

      image2: "/../../../images/food-images/morocco-food7.jpg",
      ...
      image3:
        ...
        "/../../../images/merzouga-images/desert-images/desert-images6.jpg",
      //"/../../../images/activties-images/activties-images.jpg"
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/altas-images/altas-images-5.jpg",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-6.jpg",
