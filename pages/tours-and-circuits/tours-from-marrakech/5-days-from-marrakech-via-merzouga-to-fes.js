...
const Index = () => {
  const id = "5MMF";
  const SeoTitle =
    " 5 Days Tour from Marrakech Via Merzouga Desert to Fes ";
  const ProgramName = " 5 Days Tour from Marrakech Via Merzouga Desert to Fes";

  const FocuseKeyOne = " 5 Days Trip Morocco Itinerary ";
  const FocuseKeyTwo = " 5 Day Sahara Desert Tour Morocco staring Marrakech ";
  const FocuseKeyTree = " 5 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 5 Days Marrakech Via Merzouga Desert to Fes";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou6.webp",
      // A FOOD IMAGES /

      image2: "/../../../images/food-images/morocco-food8.jpg",
      ...
      image3:
        ...
        "/../../../images/merzouga-images/desert-images/desert-images3.jpg",
      //"/../../../images/activties-images/activties-images.jpg"
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/altas-images/altas-images-6.jpg",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-7.jpg",
