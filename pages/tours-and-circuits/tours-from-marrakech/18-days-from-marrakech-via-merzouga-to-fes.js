...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = "18 Days Trip from Marrakech to Fes Via Merzouga Desert.";
  const ProgramName = "18 Days Trip from Marrakech to Fes Via Merzouga Desert.";

  const FocuseKeyOne = " 18 Day Dorocco Itinerary ";
  const FocuseKeyTwo = " 18 Day to Merzouga Desert Tour Morocco ";
  const FocuseKeyTree = " 18 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 18 Days Marrakech to Fes Via Merzouga Desert ";
