...
const Index = () => {
  const id = "5MMF";
  const SeoTitle =
    "  6 Days Round Tour from Marrakech Via Merzouga Sahara Desert ";
  const ProgramName =
    " 6 Days Round Tour from Marrakech Via Merzouga Sahara Desert ";

  const FocuseKeyOne = " 6 Day Dorocco Itinerary ";
  const FocuseKeyTwo = " 6 Day Sahara Desert Tour Morocco ";
  const FocuseKeyTree = " 6 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 6 Days Marrakech Via Merzouga Desert ";
