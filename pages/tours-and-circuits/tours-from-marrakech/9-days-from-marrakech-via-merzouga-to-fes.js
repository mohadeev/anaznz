...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = "9 Day Tour From Marrakech to Fes via Sahara Desert.";
  const ProgramName = "9 Day Tour From Marrakech to Fes via Sahara Desert.";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou20.jpg",
      image1postion: "bottom",

      // A FOOD IMAGES /

      image2: "/../../../images/marrakech-images/marrakech-images-11.jpg",
      image2postion: "top-center",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-21.jpg",

      image3postion: "bottom",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-32.jpg",
      image4postion: "",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-22.jpg",
      image5postion: "",
