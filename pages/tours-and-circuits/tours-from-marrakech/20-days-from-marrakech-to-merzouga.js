...
const Index = () => {
  const id = "5MMF";
  const SeoTitle =
    "20 Days Grand Tour from Marrakech South East Merzouga and impirail Cities.";
  const ProgramName =
    "20 Days Grand Tour from Marrakech South East Merzouga & impirail Cities.";

  const FocuseKeyOne = " 20 Day Dorocco Itinerary ";
  const FocuseKeyTwo = " 20 Day to Merzouga Desert Tour Morocco ";
  const FocuseKeyTree = " 20 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 20 Days Marrakech to Fes Via Merzouga Desert ";
