...
const Index = () => {
  const id = "5MMF";
  const SeoTitle =
    "17 Days Grand Tour from Marrakech South East Merzouga and impirail Cities.";
  const ProgramName =
    "17 Days Grand Tour from Marrakech South East Merzouga & impirail Cities.";
