...
const Index = () => {
  const id = "5MMF";
  const SeoTitle = "  3 Days Tour from Marrakech Via Merzouga to Fes ";
  const ProgramName = " 3 Days Tour from Marrakech Via Merzouga to Fes ";

  const FocuseKeyone = " 3 day morocco itinerary ";
  const FocuseKeyTwo = " 3 Day Sahara Desert Tour Morocco ";
  const FocuseKeyTree = " 3 Days Holiday in Marrakech and Merzouga to Fes ";
  const FocuseKeyFour = " 3 Days Trip Package From Marrakech to Fes City  ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou1.jpg.jpg",
      // A FOOD IMAGES /
      image2: "/../../../images/food-images/morocco-food2.jpg",
      ...
      image3:
        ...
        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-5.jpg",
      //"/../../../images/activties-images/activties-images.jpg"
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/altas-images/altas-images-2.jpg",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-2.jpg",

      // ACTIVTIES 4 QUAD BIKE OR Sky
      image6: "/../../../images/merzouga-images/quad-images/quad-images-2.webp",
  ...
  const [TourItinirary, setTourItinirary] = useState([
    {
      overview: (
        <p>
          The <b>{ProgramName}</b> gives you the chance to experience southern
          Morocco&apos;s beauty, like the magnificent high Atlas Mountains,
          enjoying the most spectacular scenery and the Berber ethnic villages,
          your <b>{FocuseKeyTwo}</b> will go on to discover the Ksar of Ait ben
          Haddou, the world-famous Kasbah, which was declared a World Cultural
          Heritage by UNESCO in 1986. Many movies have been shot in this most
          spectacular place, among them Gladiator, Obelix, The Mummy, The Jewel
          of the Nile, Sahara with Penélope Cruz... Etc. we will continue to
          Ouarzazate to tour the Oscar Atlas Film Studio, the greatest film
          studio in Morocco, and the Kasbah of Taourirt. Then our Desert Tour
          from Marrakech to Fes continues through the palm tree grove of Skoura,
          the Rose Valley, famous for its yearly rose festival and cosmetics,
          the verdant Dades Gorge and the mesmerizing Todra Valley, a renowned
          place for rock climbing, and eventually we reach our favorite
          Destination &quot; Merzouga - the Erg Chebbi Sahara, where we will
          take a Camel Ride to see the sunset and enjoy a Magical overnight in a
          Berber Lager Camp. The following day we drive to Fes, and we stop on
          the way to appreciate the scenery, take photos of the Ziz Valley,
          marvel at the lovely scenery of the Middle Atlas Mountains, to see the
          Cedar Forest of Azrou and Ifrane, and then head to Fes where our{" "}
          <b>{FocuseKeyFour}</b> will be Finished.
        </p>
      ),
    },
  ]);
