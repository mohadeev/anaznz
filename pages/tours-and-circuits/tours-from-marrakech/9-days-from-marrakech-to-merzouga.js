...
const Index = () => {
  const id = "5MMF";
  const SeoTitle =
    "9 Days Trip from Marrakech to Sahara Desert and Essaouira Tour.";
  const ProgramName =
    "9 Days Trip from Marrakech to Sahara Desert and Essaouira Tour.";

  const FocuseKeyOne = " 9 Day Dorocco Itinerary ";
  const FocuseKeyTwo = " 9 Day to Merzouga Desert Tour Morocco ";
  const FocuseKeyTree = " 9 Days Tour Package from Marrakech ";
  const FocuseKeyFour = " 9 Days Marrakech to Fes Via Merzouga Desert ";
  ...
  const [TourArray, setTourArray] = useState([
    {
      ...
      image1:
        "/../../../images/ait-ben-haddou-images/ourzazate-aitbenhadou18.jpg",
      image1postion: "bottom",

      // A FOOD IMAGES /

      image2: "/../../../images/marrakech-images/marrakech-images-10.jpg",
      image2postion: "top-center",
      // ACTIVTIES 1 / ANIMALS
      image3:
        // ACTIVTIES 2 CALM OR NATUTRE PLACE
        "/../../../images/altas-images/altas-images-19.jpg",

      image3postion: "center",
      image4:
        // ACTIVTIES 3 GROUP PEOPLPE

        "/../../../images/merzouga-images/camels-images/desert-camels-merzouga-30.jpg",
      image4postion: "",

      // CITY
      image5: "/../../../images/merzouga-images/camp-mages/camp-images-21.jpg",
      image5postion: "bottom",
